    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-primary)]">
      <div className="text-center max-w-[600px] p-10">
        ...
        <div className="flex flex-col gap-4 max-w-[300px] mx-auto">
          <Link to="/register" className="py-3 px-6 rounded-3xl no-underline bg-[var(--accent)] color-white font-bold text-[15px] text-center">
            Create account
          </Link>
          ...
          <Link to="/login" className="py-3 px-6 border border-[var(--border)] rounded-3xl no-underline bg-transparent color-[var(--accent)] font-bold text-[15px] text-center">
            Sign in
          </Link>
        </div>
      </div>
